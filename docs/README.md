...
| [Tools, integrations, and security](03-tools-integrations-security/README.md) | Built-in and hosted tools, permissions, MCP, plugins, hooks, computer-use MCP, settings policy, Artifact, Claude Design, and IDE/Chrome integrations. |
...
| [Agents and automation](06-agents-automation/README.md) | Custom/background/observer agents, task/subagent tools, lifecycle hooks, slash commands, and auto-mode. |
