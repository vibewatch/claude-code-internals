...
| [Runtime lifecycle](01-runtime-lifecycle/README.md) | Package/Bun bootstrap, CLI flags, root command routing, headless/interactive modes, terminal renderer/input, accessibility, model-ended conversation termination, and subcommands. |
...
| [Tools, integrations, and security](03-tools-integrations-security/README.md) | Built-in and hosted tools, permissions, MCP, plugin lifecycle/configuration, Chrome automation, IDE/LSP, hooks, status-line commands, computer-use MCP, settings policy, Artifact, and Claude Design. |
| [Sessions, persistence, and remote](04-sessions-persistence-remote/README.md) | Local JSONL transcripts, resume/continue/fork/rewind, attached Project knowledge, team onboarding/share flows, hosted sessions, teleport, Remote Control, and remote-runner egress/file staging. |
| [Operations and native support](05-hosted-agent-ops/README.md) | Debug logs, telemetry/traffic policy, enterprise gateway, doctor/update, safe-mode recovery, hosted review signals, and native image/audio modules. |
| [Agents and automation](06-agents-automation/README.md) | Custom/background/observer agents, worktree isolation, cross-agent messaging, experimental Agent Teams, task/subagent tools, lifecycle hooks, slash commands, and auto-mode. |
| [Research atlas](99-research-atlas/README.md) | Generated module/string inventories, source-anchor methodology, domain ledgers, full-system coverage review, documentation-structure decisions, and promotion rules. |
...
| Understand one complete local run | [CLI main paths](01-runtime-lifecycle/cli-main-paths.md) → [Terminal UI renderer and input lifecycle](01-runtime-lifecycle/terminal-ui-renderer-and-input.md) → [Prompt, context, and memory](02-context-model-loop/prompt-context-memory.md) → [Prompt assembly scenarios](02-context-model-loop/prompt-assembly-scenarios.md) |
...
| Understand scriptable/headless mode | [Command-line reference](01-runtime-lifecycle/command-line-reference.md) → [Headless streaming and resilience](02-context-model-loop/headless-streaming-and-resilience.md) → [Context and model loop architecture](02-context-model-loop/architecture.md) |
...
| Understand hosted-runner networking and files | [Remote control and teleport](04-sessions-persistence-remote/remote-control-and-teleport.md) → [Remote-environment egress and file staging](04-sessions-persistence-remote/remote-environment-egress-and-file-staging.md) → [Sandbox and isolation](03-tools-integrations-security/sandbox-and-isolation.md) |
| Operate the enterprise gateway | [Enterprise gateway server](05-hosted-agent-ops/enterprise-gateway.md) → [Models, providers, and auth](02-context-model-loop/models-providers-auth.md) → [Settings, policy, and integrations](03-tools-integrations-security/settings-policy-and-integrations.md) → [Telemetry and tracing](05-hosted-agent-ops/telemetry-and-tracing.md) |
| Review trust boundaries | [Tools, integrations, and security](03-tools-integrations-security/README.md) → [Tool runtime, events, and integration flows](03-tools-integrations-security/tool-runtime-events-and-integrations.md) → [Built-in tools and permissions](03-tools-integrations-security/built-in-tools-and-permissions.md) → [Sandbox and isolation](03-tools-integrations-security/sandbox-and-isolation.md) → [MCP, plugins, and hooks](03-tools-integrations-security/mcp-plugins-hooks.md) → [Plugin lifecycle and configuration](03-tools-integrations-security/plugin-lifecycle-and-configuration.md) → [Browser automation and Claude in Chrome](03-tools-integrations-security/browser-automation-and-claude-in-chrome.md) |
...
| Understand voice/audio dictation | [Operations and native support](05-hosted-agent-ops/README.md) → [Media native modules](05-hosted-agent-ops/media-native-modules.md) → [Audio capture and voice mode](05-hosted-agent-ops/audio-capture-and-voice.md) |
| Study agents and automation | [Agents and automation](06-agents-automation/README.md) → [Agents, tasks, and subagents](06-agents-automation/agents-tasks-and-subagents.md) → [Worktree isolation and handoffs](06-agents-automation/worktree-isolation-and-handoffs.md) → [Agent messaging and communication](06-agents-automation/agent-messaging.md) → [Agent Teams](06-agents-automation/agent-teams.md) → [Observer agents](06-agents-automation/observer-agents.md) → [Agent steering, interruption, and completion](06-agents-automation/agent-steering-interruption-and-completion.md) → [Dynamic workflows](06-agents-automation/dynamic-workflows.md) |
...
| Terminal rendering and input | [Terminal UI renderer and input lifecycle](01-runtime-lifecycle/terminal-ui-renderer-and-input.md) | [Accessibility and screen-reader mode](01-runtime-lifecycle/accessibility-and-screen-reader-mode.md), [Command-line reference](01-runtime-lifecycle/command-line-reference.md) |
...
| Browser automation | [Browser automation and Claude in Chrome](03-tools-integrations-security/browser-automation-and-claude-in-chrome.md) | [Built-in tools and permissions](03-tools-integrations-security/built-in-tools-and-permissions.md), [MCP, plugins, and hooks](03-tools-integrations-security/mcp-plugins-hooks.md), [Computer-use MCP](03-tools-integrations-security/computer-use-mcp.md) |
| IDE and language servers | [IDE integration and LSP diagnostics](03-tools-integrations-security/ide-integration-and-lsp-diagnostics.md) | [Plugin lifecycle and configuration](03-tools-integrations-security/plugin-lifecycle-and-configuration.md), [Tool runtime, events, and integration flows](03-tools-integrations-security/tool-runtime-events-and-integrations.md) |
| Plugin extension lifecycle | [Plugin lifecycle and configuration](03-tools-integrations-security/plugin-lifecycle-and-configuration.md) | [MCP, plugins, and hooks](03-tools-integrations-security/mcp-plugins-hooks.md), [Settings, policy, and integrations](03-tools-integrations-security/settings-policy-and-integrations.md), [Skills system](03-tools-integrations-security/skills-system.md) |
| Session/event lifecycle | [Session API, events, and storage](04-sessions-persistence-remote/session-api-events-and-storage.md) | [Data models and frame schemas](04-sessions-persistence-remote/data-models-and-frame-schemas.md), [Hooks and events reference](03-tools-integrations-security/hooks-and-events-reference.md), [Operations and native support](05-hosted-agent-ops/README.md) |
...
| Remote-runner egress and files | [Remote-environment egress and file staging](04-sessions-persistence-remote/remote-environment-egress-and-file-staging.md) | [Sandbox and isolation](03-tools-integrations-security/sandbox-and-isolation.md), [MCP, plugins, and hooks](03-tools-integrations-security/mcp-plugins-hooks.md) |
| Enterprise inference gateway | [Enterprise gateway server](05-hosted-agent-ops/enterprise-gateway.md) | [Models, providers, and auth](02-context-model-loop/models-providers-auth.md), [Telemetry and tracing](05-hosted-agent-ops/telemetry-and-tracing.md), [Settings, policy, and integrations](03-tools-integrations-security/settings-policy-and-integrations.md) |
| Permissions and policy | [Tools, integrations, and security](03-tools-integrations-security/README.md) | [Context and model loop](02-context-model-loop/README.md), [Operations and native support](05-hosted-agent-ops/README.md) |
| Settings, hooks, status line, and environment references | [Settings schema reference](03-tools-integrations-security/settings-schema-reference.md) | [Hooks and events reference](03-tools-integrations-security/hooks-and-events-reference.md), [Status line runtime and command protocol](03-tools-integrations-security/status-line.md), [Environment variables reference](05-hosted-agent-ops/environment-variables-reference.md), [Settings, policy, and integrations](03-tools-integrations-security/settings-policy-and-integrations.md), [Plugin lifecycle and configuration](03-tools-integrations-security/plugin-lifecycle-and-configuration.md) |
...
| Subagents and automation | [Agents, tasks, and subagents](06-agents-automation/agents-tasks-and-subagents.md) | [Agent steering, interruption, and completion](06-agents-automation/agent-steering-interruption-and-completion.md), [Tools, integrations, and security](03-tools-integrations-security/README.md), [Sessions, persistence, and remote](04-sessions-persistence-remote/README.md) |
| Worktree isolation | [Worktree isolation and handoffs](06-agents-automation/worktree-isolation-and-handoffs.md) | [Agents, tasks, and subagents](06-agents-automation/agents-tasks-and-subagents.md), [Session resume and transcripts](04-sessions-persistence-remote/session-resume-and-transcripts.md), [Hooks and events reference](03-tools-integrations-security/hooks-and-events-reference.md) |
| Agent messaging and replies | [Agent messaging and communication](06-agents-automation/agent-messaging.md) | [Runtime communication protocols](00-start-here/runtime-communication-protocols.md), [Agent Teams](06-agents-automation/agent-teams.md), [Agent steering, interruption, and completion](06-agents-automation/agent-steering-interruption-and-completion.md) |
...
| Classic/fullscreen rendering, raw input, resize, suspend, and `/tui` relaunch | [Terminal UI renderer and input lifecycle](01-runtime-lifecycle/terminal-ui-renderer-and-input.md) |
...
| Plugin manifests, dependencies, enablement, defaults, user options, and reload | [Plugin lifecycle and configuration](03-tools-integrations-security/plugin-lifecycle-and-configuration.md) |
| Chrome extension/native-host bridge, browser tools, tab groups, and permissions | [Browser automation and Claude in Chrome](03-tools-integrations-security/browser-automation-and-claude-in-chrome.md) |
| IDE discovery/dynamic MCP and plugin LSP diagnostic delivery | [IDE integration and LSP diagnostics](03-tools-integrations-security/ide-integration-and-lsp-diagnostics.md) |
...
| Remote-runner HTTPS proxy, working sync, filestore, and staged MCP lanes | [Remote-environment egress and file staging](04-sessions-persistence-remote/remote-environment-egress-and-file-staging.md) |
...
| Enterprise OIDC/inference/policy/spend/OTLP gateway | [Enterprise gateway server](05-hosted-agent-ops/enterprise-gateway.md) |
| Task/subagent runtime behavior | [Agents, tasks, and subagents](06-agents-automation/agents-tasks-and-subagents.md) |
| Session/agent worktree creation, locking, persistence, and safe cleanup | [Worktree isolation and handoffs](06-agents-automation/worktree-isolation-and-handoffs.md) |
...
| Agent steering, interruption, cancellation, and completion | [Agent steering, interruption, and completion](06-agents-automation/agent-steering-interruption-and-completion.md) |
| Timed prompt scheduling and cron | [Cron and scheduled tasks](06-agents-automation/cron-and-scheduled-tasks.md) |
...
| Repository-wide coverage decisions and rejected false gaps | [Full-system documentation coverage review](99-research-atlas/full-system-coverage-review.md) |
| Executable-string discoveries, promotions, aliases, noise, and native limits | [Disassembled string-surface review](99-research-atlas/disassembled-string-surface-review.md) |
| Canonical page ownership, filename decisions, duplicate merges, and intentional non-merges | [Documentation structure and duplication review](99-research-atlas/documentation-structure-review.md) |
