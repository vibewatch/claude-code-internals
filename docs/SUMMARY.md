...
- [Runtime lifecycle](01-runtime-lifecycle/README.md)
	...
	- [Terminal UI renderer and input lifecycle](01-runtime-lifecycle/terminal-ui-renderer-and-input.md)
...
- [Tools, integrations, and security](03-tools-integrations-security/README.md)
	...
	- [Browser automation and Claude in Chrome](03-tools-integrations-security/browser-automation-and-claude-in-chrome.md)
	- [Computer-use MCP](03-tools-integrations-security/computer-use-mcp.md)
	- [IDE integration and LSP diagnostics](03-tools-integrations-security/ide-integration-and-lsp-diagnostics.md)
	...
	- [Plugin lifecycle and configuration](03-tools-integrations-security/plugin-lifecycle-and-configuration.md)
...
- [Operations and native support](05-hosted-agent-ops/README.md)
...
- [Agents and automation](06-agents-automation/README.md)
	...
	- [Dynamic workflows](06-agents-automation/dynamic-workflows.md)
...
- [Research atlas](99-research-atlas/README.md)
	...
	- [Full-system documentation coverage review](99-research-atlas/full-system-coverage-review.md)
	- [Documentation structure and duplication review](99-research-atlas/documentation-structure-review.md)
	- [Disassembled string-surface review](99-research-atlas/disassembled-string-surface-review.md)
	- [Runtime mechanism question audit](99-research-atlas/mechanism-question-audit-runtime.md)
	- [Context/model mechanism question audit](99-research-atlas/mechanism-question-audit-context-model.md)
	- [Tools/security mechanism question audit](99-research-atlas/mechanism-question-audit-tools-security.md)
	- [Sessions/remote mechanism question audit](99-research-atlas/mechanism-question-audit-sessions-remote.md)
	- [Operations/native mechanism question audit](99-research-atlas/mechanism-question-audit-operations-native.md)
	- [Agents/automation mechanism question audit](99-research-atlas/mechanism-question-audit-agents-automation.md)
