...
- [`docs/01-runtime-lifecycle/conversation-termination.md`](docs/01-runtime-lifecycle/conversation-termination.md) and [`docs/06-agents-automation/observer-agents.md`](docs/06-agents-automation/observer-agents.md) — new `2.1.215` model-ended-session and observer-agent lifecycles, including their durable transcript markers.
