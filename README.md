...
- [`docs/01-runtime-lifecycle/conversation-termination.md`](docs/01-runtime-lifecycle/conversation-termination.md), [`docs/06-agents-automation/observer-agents.md`](docs/06-agents-automation/observer-agents.md), and [`docs/06-agents-automation/agent-teams.md`](docs/06-agents-automation/agent-teams.md) — `2.1.215` model-ended-session, observer-agent, and experimental Agent Teams lifecycles, including the team's roster/task/mailbox coordination and clean-exit persistence boundary.
- [`docs/03-tools-integrations-security/computer-use-mcp.md`](docs/03-tools-integrations-security/computer-use-mcp.md) and [`docs/04-sessions-persistence-remote/team-onboarding-and-share-flows.md`](docs/04-sessions-persistence-remote/team-onboarding-and-share-flows.md) — older source-confirmed macOS computer-control and onboarding/share subsystems promoted from generated-only or incidental coverage.
- [`docs/03-tools-integrations-security/status-line.md`](docs/03-tools-integrations-security/status-line.md) — `/statusline` setup versus runtime JSON stdin, refresh/cancellation, shell/environment/trust boundaries, rendering, and the separate `subagentStatusLine` JSONL protocol.
- [`docs/03-tools-integrations-security/plugin-lifecycle-and-configuration.md`](docs/03-tools-integrations-security/plugin-lifecycle-and-configuration.md) — plugin discovery, installation/enablement scopes, manifest contributions, dependency/version constraints, plugin defaults, and secure `userConfig` storage/substitution.
- [`docs/05-hosted-agent-ops/enterprise-gateway.md`](docs/05-hosted-agent-ops/enterprise-gateway.md) — native `gateway --config`, strict YAML/secrets, Postgres migrations/retention, OIDC device auth, provider routing, managed policy, spend controls, OTLP relay, and network hardening.
- [`docs/04-sessions-persistence-remote/remote-environment-egress-and-file-staging.md`](docs/04-sessions-persistence-remote/remote-environment-egress-and-file-staging.md) — hosted-runner CONNECT-over-WebSocket egress, CA/tool trust, governed Git/`gh`, optimistic working-file sync, `/uploads` filestore staging, and staged MCP file lanes.
- [`docs/01-runtime-lifecycle/terminal-ui-renderer-and-input.md`](docs/01-runtime-lifecycle/terminal-ui-renderer-and-input.md), [`docs/03-tools-integrations-security/browser-automation-and-claude-in-chrome.md`](docs/03-tools-integrations-security/browser-automation-and-claude-in-chrome.md), [`docs/03-tools-integrations-security/ide-integration-and-lsp-diagnostics.md`](docs/03-tools-integrations-security/ide-integration-and-lsp-diagnostics.md), and [`docs/06-agents-automation/worktree-isolation-and-handoffs.md`](docs/06-agents-automation/worktree-isolation-and-handoffs.md) — the full-system review's promoted terminal, browser, IDE/LSP, and worktree lifecycles.
- [`docs/99-research-atlas/full-system-coverage-review.md`](docs/99-research-atlas/full-system-coverage-review.md) — repository-wide audit method, promoted gaps, source corrections, rejected false gaps, and remaining evidence limits.
- [`docs/99-research-atlas/disassembled-string-surface-review.md`](docs/99-research-atlas/disassembled-string-surface-review.md) — independent executable-string/registration/native audit, promoted owners, absorbed findings, aliases/noise, and evidence limits.
- [`docs/99-research-atlas/documentation-structure-review.md`](docs/99-research-atlas/documentation-structure-review.md) — page ownership, filename/title review, duplicate consolidation, and intentional architecture/reference/lifecycle boundaries.
